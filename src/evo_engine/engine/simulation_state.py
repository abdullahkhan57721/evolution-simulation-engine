...
class SimulationState:
    ...
    configuration. Copies of the simulation state share those models while
    independently copying the mutable world and random-number-generator state.
    ...
    def copy(self) -> SimulationState:
        ...
        The mutable world and RNG state are copied. Shared immutable/pure
        simulation configuration is retained by reference.
        ...
        # Genetic architecture and behavior selection are shared configuration.
