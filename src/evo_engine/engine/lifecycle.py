...
def build_standard_lifecycle(
    *,
    ...
    metabolism, and after later voluntary energy expenditures. Maximum-age
    mortality is checked at entry and again after Aging increments age. This
    makes age equal completed timesteps lived: an organism with maximum age 5
    is removed when its age becomes 5, before it can begin a sixth timestep.
    ...
    Args:
        ...
        aging_stage: Stage incrementing age after the timestep's activities.
